...
void SSD1306_Mini::init()
{
  ...
  sendCommand(0x20); // set horizontal addressing mode
  sendCommand(0x00);
  sendCommand(0xC8); // remapped mode
  sendCommand(0xA1); // column address 127 is mapped to SEG0
  sendCommand(0xA8); // set MUX ratio to 32
  sendCommand(0x1F);
  sendCommand(0xDA); // set config pin
  sendCommand(0x12);
